...
The custom menu contains a Home link which always appears to the

very left, and a My courses and Login/Logout link, which appears

after any administrator-added items.



Aerie has a settings page that lets you modify various background

colours, custom footer, custom css, and the site logo.
...
properly, even when all blocks are docked or removed from side-pre

and side-post.
Block regions are now named properly in the selector for default
