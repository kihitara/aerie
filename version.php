...
$plugin->version   = 2012102401; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '0.6.5 (Build: 2012102401)';
$plugin->component = 'theme_aerie'; // Full name of the plugin (used for diagnostics)